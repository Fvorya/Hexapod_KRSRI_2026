...
float vx, vy, dan vz <- buat ngasih tau jarak target dari pangkal coxa

float a <- buat muter sumbu x ke depan tiap kaki
flaot lx <- buat ngasih tau nilai x ke target dari masing-masing pangkal coxa kaki
float ly <- kebalikannya

sama file .ino nya diganti buat ngetes body kienmatics dulu
